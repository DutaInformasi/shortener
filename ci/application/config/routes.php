...
$route['stats/lists'] = "stats/lists"; // allow the tats controller to be used
$route['stats/links'] = "stats/links"; // allow the tats controller to be used
$route['stat_lists/$1'] = "stats/lists/$1";
